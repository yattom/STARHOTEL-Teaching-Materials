...
public class PracticeWork1 {
    ...
    public void test() {
        ...
        assertThat(driver.findElement(By.id("datefrom")).getText(), is("2013年12月7日")); // TODO 変更する
        assertThat(driver.findElement(By.id("dateto")).getText(), is("2013年12月8日")); // TODO 変更する
