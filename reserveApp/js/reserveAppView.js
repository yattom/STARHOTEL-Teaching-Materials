...
var starHotelView = {
    ...
    checkInfo_isErrorRender: function(checkValRes, dateValue) {
        ...
        // loom count check
        var roomCount =
            parseInt(checkValRes.single_s, 10) + parseInt(checkValRes.single_ns, 10) +
            ((parseInt(checkValRes.double_s, 10) + parseInt(checkValRes.double_ns, 10)) * 2);
        if (roomCount !== parseInt(checkValRes.hc, 10)) {
    ...
    renderCheckInfo: function(totalBill, dateValue) {
        ...
        if (parseInt(checkValRes.single_s, 10) > 0) {
            $("#billing").append("<h4 id='count_single_s'>" + "シングル(喫煙)" + checkValRes.single_s + "人 = " + parseInt(checkValRes.single_s, 10) * 7000 + "円</h4>");
        }
        if (parseInt(checkValRes.double_ns, 10) > 0) {
            $("#billing").append("<h4 id='count_double_ns'>" + "ダブル(禁煙)" + parseInt(checkValRes.double_ns, 10) * 2 + "人 = " + parseInt(checkValRes.double_ns, 10) * 6000 * 2 + "円</h4>");
        }
